...
namespace One_data_share {
    ...
    enum class Oauth_endpoint_type {
        dropbox, googledrive, box, gftp
    };

    /**
     * Service providing all functionality related to registering credentials
     * with One Data Share. Credential_service objects cannot be copied via their copy 
    ...
    public:
         ...
         * Credential_service object is valid and that a connection can be
         ...
         * token used to create this Credential_service object is valid and
