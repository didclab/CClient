...
namespace One_data_share {
    ...
    public:
         ...
         */
        static std::unique_ptr<Destination> create(Endpoint_type type, std::string cred_id, std::string directory_identifier);
    ...
    public:
         ...
         */
        static std::unique_ptr<Source> create(Endpoint_type type, std::string cred_id, std::string directory_identifier, std::vector<std::string> resource_identifiers);
    ...
    public:
        /**
         * Creates a new Transfer_service object with the specified
         * authentication token, passing ownership of the Transfer_service
         ...
         */
        virtual std::string transfer(const Source& source, const Destination& destination, const Transfer_options& options) const = 0;

        /**
         * Checks the status of the specified transfer job by creatinh a new
         * Transfer_status object whose ownership is passed to the caller.
         * 
