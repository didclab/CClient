...
public:
    ...
    /**
     * Creates a new Transfer_service object with the specified authentication token communicating with OneDataShare
     ...
     * connection can be made to OneDataShare, that a connection can be made to the source endpoint, that a
     ...
     * that OneDataShare is able to read and write as neceessary. If these preconditions are not met, exceptions may
     * be thrown.
     *
     ...
     * object is valid, that a connection can be made to OneDataShare, and that the specified id is a valid job
