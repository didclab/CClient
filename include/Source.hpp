...
namespace ods {
    ...
    class Source {
        public:
             ...
             * @param resource_identifiers borrowed reference to the the names
             * or ids, depending on the endpoint type, that are needed in order
             * to locate the resources to transfer from within the specified
             * directory
             * 
