    ...
    namespace internal {
        ...
        class CredentialServiceImpl: public CredentialService {
            public:
                 ...
                 * 
                 * @param ods_auth_token token to use for REST API calls
                 * @param ods_url url to make REST API calls to
                 * @param rest_caller object to use for making REST API calls
                 */
                CredentialServiceImpl(std::string ods_auth_token, std::string ods_url, std::unique_ptr<rest::Rest> rest_caller);
