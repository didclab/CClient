...
namespace {
    ...
    constexpr std::array CREDENTIAL_TYPES{One_data_share::Credential_endpoint_type::ftp,
    ...
    public:
        ...
        MOCK_METHOD(One_data_share::Response,
                    post,
                    (const std::string& url, const HeaderMap& headers, const std::string& data),
                    (const, override));
    };
